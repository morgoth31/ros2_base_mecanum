...
# Clear the screen, set color to red, move cursor to calculated position, and display the text
#echo -e "\033[2J\033[31m\033[1;${padding}H[${SystemInfo}]\033[0m"

# Print ROS Version
# echo -e "\033[34mROS: $(printenv ROS_DISTRO)\033[0m"
# Print ROS DOMAIN ID
# echo -e "\033[34mDOMAIN_ID: $(printenv ROS_DOMAIN_ID)\033[0m"
# Print IP address 1
...
#source /home/ros/ros2_ws/software/library_ws/install/setup.bash
...
alias build='cd ~/ros2_ws && colcon build --symlink-install && source install/setup.bash && cd -'
alias run='cd ~/ros2_ws && ros2 launch mecanumbot_bringup mecanumbot_hardware.py && cd -'